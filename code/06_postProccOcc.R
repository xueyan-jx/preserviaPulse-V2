## Purpose of script:
## 1. Make sure final plants and animals occ points have the same format for SSDM
## 2. Add CNDDB data
## Authors: GEOG 274
## Date: Spring, 2025
...
write.table(merged_df, file.path('data/occurrences/Anim_Plant_merge_final0711.csv'), sep=',', row.names = FALSE)
